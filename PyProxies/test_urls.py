"""
Just some random URLs of more or less well known websites for testing purposes

Test the URLs and print a list of function URLs by running this file

The implementation of the tests can be seen below at the main entry point

These URLs are also used to test the free proxies
"""
